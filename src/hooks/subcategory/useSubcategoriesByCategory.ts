...
export function useSubcategoriesByCategory(
  ...
  return useQuery(
    [QueryKeys.SUBCATEGORY, 'by-category', categoryId, page, size, sort, type, keyword, archived],
    () => getSubcategoriesByCategory(categoryId, page, size, sort, type, keyword, archived),
    {
