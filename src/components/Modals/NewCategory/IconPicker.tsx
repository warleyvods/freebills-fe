import { Button, SimpleGrid, Stack, Text, Image, useColorModeValue, HStack, Input } from "@chakra-ui/react";
...
export const IconPicker = ({onIconSelected}: Props) => {
  ...
  const [displayedIconNames, setDisplayedIconNames] = useState(iconNames.slice(0, batchSize))
